...
public class AppUpdateUtils {
    public static int ErrorHasChecked = 999;
    ...
    public static void update(final Context context, final BmobUpdateListener listener) {
        ...
        if ((currentTime - SpUtils.lastUpdata(context)) > 24 * 60 * 60 * 1000) {
            ...
            SpUtils.lastUpdata(context, currentTime);
        } else {
            listener.onUpdateReturned(ErrorHasChecked, null);
        }
    }
    ...
    private static void showConfirmDialog(Context context, AppPatchBmobBean appPatchBmobBean, final View.OnClickListener onSubmitClickListener) {
        ...
        /*升级日志*/
        TextView mlogTv = (BmobUpdateTextView) view.findViewById(R.id.bmob_update_content);
        ...
        sb.append(context.getResources().getString(R.string.BMUpdateContent));
