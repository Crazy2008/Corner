 ...
 */
public class WytTriangularPagerIndicator extends View implements IPagerIndicator {
    ...
    public WytTriangularPagerIndicator(Context context) {
        super(context);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        mLineHeight = UIUtil.dip2px(context, 0);
